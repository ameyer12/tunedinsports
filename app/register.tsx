...
export default function RegisterScreen() {
  ...
  const signUp = async () => {
    ...
    try {
      ...
      if(error.message == "Firebase: Error (auth/missing-password)."){
        alert('Registration failed: Please enter a password');
      } else if(error.message == "Firebase: Error (auth/invalid-email)."){
        alert('Registration failed: Please enter a valid email');
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Sign up to save matches</Text>
      <TextInput 
        placeholder="Email"
